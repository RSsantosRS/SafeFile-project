...
# --- Campos de Login ---
y_pos_label_email = 0.35 # Ajustado para descer um pouco devido ao título mais alto
...
RELY_BOTAO_LOGIN = 0.65 # Posição Y para o botão Login
...
RELY_LINK_CADASTRO = RELY_BOTAO_LOGIN + 0.10 # Espaçamento abaixo do botão Login

botao_link_cadastro = tk.Button(
    janela_login,
    text="Primeira vez? Cadastre-se",
    font=fonte_botao_secundario_str, # Usando a fonte secundária comum
...
RELY_BOTAO_VOLTAR_INICIO = RELY_LINK_CADASTRO + 0.10 # Espaçamento abaixo do botão de cadastro
...
botao_voltar_inicio = tk.Button(
    ...
    activebackground=cor_azul_claro,
    activeforeground="white",
    command=ir_para_inicio_da_tela_login, # Chama a nova função
    relief=tk.FLAT,
    bd=0,
    highlightthickness=0,
    cursor="hand2"
